...
@section('content')
    ...
    @endif
    <div class="main_container" style="min-height: 65vh;" data-aos="fade-up" data-aos-duration="1000">
            ...
            <div class="row">
                @foreach ($rooms as $key => $room)
                    <div class="col-lg-4 col-3 d-flex justify-content-center mb-5">
                        <div class="room_card">
                            <div class="row rounded-top d-flex justify-content-center align-items-center wallpaper {{ Auth::check() && !$userRooms->isEmpty() && $key == 0 ? ' user_room_border_one' : '' }}"
                            ...
                            <div
                                class="row bg-dark rounded-bottom room_info {{ Auth::check() && !$userRooms->isEmpty() && $key == 0 ? ' user_room_border_two' : '' }}">
                                <div class="container">
                                    <div class="row d-flex align-items-center">
                                        <div class="col-5">
                                            <h6 class="text-white mb-0"><i class="fa-solid fa-microphone-lines"></i>
                                                {{ $room->getUser->username }}</h6>
                                        </div>
                                    ...
                                    <div class="row d-flex justify-content-center">
                                        <div class="buttons-cta-3">
                                            <a href="{{ route('join_room', $room) }}" class="st-primary-button-3 w-button">
